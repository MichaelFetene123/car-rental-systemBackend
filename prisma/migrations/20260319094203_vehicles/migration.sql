/*
  ...
  - You are about to drop the column `vehicles` on the `car_categories` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "car_categories" DROP COLUMN "vehicles",
